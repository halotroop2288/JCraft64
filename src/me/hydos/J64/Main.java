...
public class Main {
	...
	public static final boolean Default_ShowUnhandledMemory = true;
	public static final boolean Default_ShowPifRamErrors = true;
	public static final boolean Default_ShowTLBMisses = false;
	public static final boolean Default_UseTlb = true;
	public static final boolean Default_CacheInstructions = false;
	public static final boolean Default_UseAudio = true;
	public static final boolean Default_FrameLimit = true;

	public static final String AUTO_SAVE_DIR = "./saves/";
	...
	public static boolean ShowUnhandledMemory = Default_ShowUnhandledMemory;

	public static boolean ShowTLBMisses = Default_ShowTLBMisses;

	public static boolean UseTlb = Default_UseTlb;
	public static boolean CacheInstructions = Default_CacheInstructions;

	public static boolean ShowPifRamErrors = Default_ShowPifRamErrors;

	public static boolean UseAudio = Default_UseAudio;
	public static boolean FrameLimit = Default_FrameLimit;
	...
	private static void closeCpu() {
		...
		if (pif.controllerPlugin != null)
			pif.controllerPlugin.romClosed();
	}
	...
	public static void main(String[] args) {
		...
		hMainWindow.addKeyListener(new KeyListener() {
			public void keyReleased(KeyEvent e) {
				if (pif.controllerPlugin != null)
					pif.controllerPlugin.wmKeyUp(e.getKeyCode(), 0);
			}

			public void keyPressed(KeyEvent e) {
				if (pif.controllerPlugin != null)
					pif.controllerPlugin.wmKeyDown(e.getKeyCode(), 0);
			}
	...
	public static void openRom() {
		...
		// cpu.setOps(DebugCpu.buildDebugCpuOps(cpu));
		...
		if (usePif) {
			...
			switch (country) {
				...
				default -> {
					switch (cicChip) {
						case 2:
//                            cpu.GPR[5] = 0xFFFFFFFFC95973D5L;
//                            cpu.GPR[14] = 0x000000002449A366L;
							cpu.GPR[5] = 0xC95973D5;
							cpu.GPR[14] = 0x2449A366;
							break;
						case 3:
//                            cpu.GPR[5] = 0xFFFFFFFF95315A28L;
//                            cpu.GPR[14] = 0x000000005BACA1DFL;
							cpu.GPR[5] = 0x95315A28;
							cpu.GPR[14] = 0x5BACA1DF;
							break;
						case 5:
							mem.DMEM.putInt(0x1004, 0x8DA807FC);
//                            cpu.GPR[5] = 0x000000005493FB9AL;
//                            cpu.GPR[14] = 0xFFFFFFFFC2C20384L;
							cpu.GPR[5] = 0x5493FB9A;
							cpu.GPR[14] = 0xC2C20384;
						case 6:
//                            cpu.GPR[5] = 0xFFFFFFFFE067221FL;
//                            cpu.GPR[14] = 0x000000005CD2B70FL;
