...
import me.hydos.J64.emu.gln64.rdp.combiners.Combiners;
import me.hydos.J64.emu.gln64.rdp.Gdp;
import me.hydos.J64.emu.gln64.rdp.textures.TextureCache;
...
public class OpenGlGdp {
    ...
    public static void init() {
        ...
        FloatBuffer bigArray = BufferUtils.createFloatBuffer(256 * 17);
        for (int i = 0; i < 256; i++) {
        ...
        if (Combiners.ARB_multitexture) {
            ...
            GL40.glGetIntegerv(GL40.GL_MAX_TEXTURE_UNITS, maxTextureUnits_t);
        ...
        //TODO: replace with minecraft equiviant
...
//        if (Combiners.EXT_fog_coord) { TODO: fog
//            GL40.glFogi(GL40.GL_FOG_COORDINATE_SOURCE_EXT, GL40.GL_FOG_COORDINATE_EXT);
...
//            GL40.glFogCoordPointerEXT(GL40.GL_FLOAT, SIZEOF_GLVERTEX, bigArray.slice());
//            GL40.glEnableClientState(GL40.GL_FOG_COORDINATE_ARRAY_EXT);
//        }
...
//            hDC.swapBuffers();
    ...
    public static void OGL_ClearDepthBuffer(boolean depthUpdate) {
        GL40.glClearDepth(100);//Might work?
...
//            OpenGL40.OGL_GspUpdateStates();
    ...
    private static void stipple() {
        if (usePolygonStipple && (Gdp.RDP_GETOM_ALPHA_COMPARE_EN(Rsp.gdp.otherMode) == Gbi.G_AC_DITHER) && (Gdp.RDP_GETOM_ALPHA_CVG_SELECT(Rsp.gdp.otherMode) == 0)) {
            ...
            GL40.glPolygonStipple(ByteBuffer.wrap(stipplePattern[(int) (Combiners.envColor[3] * 255.0f) >> 3][lastStipple]));
        }
    }
