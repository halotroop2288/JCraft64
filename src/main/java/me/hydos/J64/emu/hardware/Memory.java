...
import me.hydos.J64.emu.DirectMemoryAccess;
import me.hydos.J64.emu.Pif;
	...
	private void swNonMemory(int pAddr, int value) throws MemoryException {
		...
		case 0x04000000:
			...
			switch (pAddr) {
				case 0x04040000: 
					{
						regSP[RegisterSP.SP_MEM_ADDR_REG] = value;
						break;
					}
				case 0x04040004:
					{
						regSP[RegisterSP.SP_DRAM_ADDR_REG] = value;
						break;
					}
				case 0x04040008: {
				...
				case 0x0404001C: 
					{
						regSP[RegisterSP.SP_SEMAPHORE_REG] = 0;
						break;
					}
				case 0x04080000:
					{
						regSP[RegisterSP.SP_PC_REG] = value & 0xFFC;
						break;
					}
